...
작업을 하면서 어렵게 해결했던 주요한 몇가지 이슈를 정리해보고자 합니다.
...
하지만, 어플이 없을 경우에 마켓으로 유도하는 과정에서<br />
os별로 딥링크 방법이 달라, `유니버셜 링크(ios)`와 `앱링크(android)`로 나누어 작업하게 되었습니다.
...
로고 하단의 네비게이션 바를 통해 페이지 이동이 가능합니다.
